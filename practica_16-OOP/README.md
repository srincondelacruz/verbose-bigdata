...
Dominar los pilares de la OOP: clases, objetos, atributos (de instancia y de clase), métodos (`@classmethod`), el constructor `__init__`, la encapsulación (`__privado`) y la interacción entre clases.
